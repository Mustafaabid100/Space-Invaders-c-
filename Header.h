...
bool isKeyPressed(int& whichKey)   //whichKey passed as reference.... 
{
	...
	key = GetAsyncKeyState(0X50);
	if (key == 1)
	{

		whichKey = 9;   // 9 if P key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x4D);
	if (key == 1)
	{

		whichKey = 10;   // 10 if M key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x45);
	if (key == 1)
	{

		whichKey = 11;   // 11 if E key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x52);
	if (key == 1)
	{

		whichKey = 12;   // 12 if R key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x48);
	if (key == 1)
	{
		whichKey = 13;  // 13 if H key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x53);
	if (key == 1)
	{
		whichKey = 14;  // 14 if S key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x4C);
	if (key == 1)
	{
		whichKey = 15;  // 15 if L key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x31);
	if (key == 1)
	{
		whichKey = 16;  // 16 if 1 key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x32);
	if (key == 1)
	{
		whichKey = 17;  // 17 if 2 key is pressed
		return true;
	}
	key = GetAsyncKeyState(0x33);
	if (key == 1)
	{
		whichKey = 18;  // 18 if 3 key is pressed
		return true;
	}
